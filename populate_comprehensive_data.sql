-- Smart Library Platform - Comprehensive Sample Data Population
-- Based on ERD requirements and user specifications
USE smart_library;

-- Clear existing data (except users table structure)
DELETE FROM reviews;
...
-- Insert users with proper password hashes (using bcrypt)
